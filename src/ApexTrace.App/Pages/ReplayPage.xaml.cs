...
{
    public ReplayPage() => InitializeComponent();
    private void OnLoaded(object sender, RoutedEventArgs e)
    {
        if (DataContext is not MainViewModel viewModel) return;
        ApplyPanelRatio(viewModel.ReplayTrackPanelRatio);
    }
    private void MainGridSplitter_OnDragCompleted(object sender, DragCompletedEventArgs e)
    {
        ...
        viewModel.SaveReplayTrackPanelRatio(TrackPanelColumn.ActualWidth / total);
    }
    ...
    private void ZoomIn_OnClick(object sender, RoutedEventArgs e) => ReplayTrack.ZoomBy(1.2);
    private void ZoomOut_OnClick(object sender, RoutedEventArgs e) => ReplayTrack.ZoomBy(0.82);
    private void Fit_OnClick(object sender, RoutedEventArgs e) => ReplayTrack.FitToView();
}
